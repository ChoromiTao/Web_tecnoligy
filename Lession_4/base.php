...
<?php
	  $name = 'Roxana';
    $prof = 'Kardiologyst';
    $city_country = 'Russia, Chita';
    $mail = 'pochta@mail.ru';
    $phone = 89100754532;
    $age = 29;
    $nav = ['Python', 'C#', 'Kardiology', 'Music'];
    $proc = [15, 15, 88, 88];
?>
<!DOCTYPE html>
<html>
    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        ...
        <div class="w3-container">
          ...
          <p><i class="fa fa-hourglass fa-fw w3-margin-right w3-large w3-text-teal"></i><?php echo $age; ?> лет, <?php echo $age * 365; ?> дней</p>
          <hr>

          <p class="w3-large"><b><i class="fa fa-asterisk fa-fw w3-margin-right w3-text-teal"></i>Навыки</b></p>
          <p><?php echo $nav[0]; ?></p>
          <div class="w3-light-grey w3-round-xlarge w3-small">
            <div class="w3-container w3-center w3-round-xlarge w3-teal" style="width: <?php echo $proc[0]; ?> %"><?php echo $nav[0]; ?>%</div>
          </div>
          <p><?php echo $nav[1]; ?></p>
          <div class="w3-light-grey w3-round-xlarge w3-small">
